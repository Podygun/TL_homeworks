...
{
    // ƒобавлена константа дл€ максимального кол-ва дней дл€ брони
    ...
    private static void HandleBook( string[] parts )
    {
        ...
        // ƒобавлена валидаци€ id пользовател€
        ...
        // ƒобавлена проверка на валидность введенных пользователем дат
        ...
        // ƒобавлена проверка оформлени€ брони на слишком долгое врем€
        ...
        // »зменен парсинг валюты, сделан вывод валидной валюты дл€ использовани€
    ...
    private static void HandleCancel( string[] parts )
    {
        ...
        // »зменен парсинг Guid через TryParse
    ...
    {
        // ƒобавлена проверка индекса команды при отмене
        if ( s_commandIndex < 1 )
        {
    ...
    private static void HandleFind( string[] parts )
    {
        ...
        // ƒобавлено добавление операции в выполненные команды
